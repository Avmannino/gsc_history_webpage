...
const exploreGroups = [
  {
    title: "About",
    links: [
      { label: "About GSC", href: `${SITE_URL}/about` },
      { label: "Club History", href: `${SITE_URL}/history` },
      { label: "Board of Governors", href: `${SITE_URL}/board` },
      { label: "GSC Alumni", href: `${SITE_URL}/alumni` },
    ],
  },
  {
    title: "Membership",
    links: [{ label: "Admissions Process", href: `${SITE_URL}/admissions` }],
  },
  {
    title: "Programs",
    links: [
      { label: "Learn to Skate", href: `${SITE_URL}/learn-to-skate` },
      { label: "Mini Mites", href: `${SITE_URL}/mini-mites` },
      { label: "Youth Travel Hockey", href: `${SITE_URL}/youth-travel-hockey` },
      { label: "Stateline Girls Hockey", href: `${SITE_URL}/stateline-girls-hockey` },
      { label: "Figure Skating", href: `${SITE_URL}/figure-skating` },
      { label: "Adult Hockey", href: `${SITE_URL}/adult-hockey` },
    ],
  },
  {
    title: "Contact",
    links: [
      { label: "Map & Directions", href: `${SITE_URL}/directions` },
      { label: "Contact Form", href: `${SITE_URL}/contact` },
    ],
  },
];
  ...
  return (
    <section className="footer-connect" aria-labelledby="connect-title">
      <div className="footer-connect__info">
        ...
        <p>
          Questions about joining Greenwich Skating Club or visiting the rink?
        </p>
